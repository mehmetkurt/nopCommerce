...
public partial class SettingModelFactory : ISettingModelFactory
{
    ...
    protected virtual async Task<OtpSettingsModel> PrepareOtpSettingsModelAsync(int storeId)
    {
        ...
        //fill in model values from the entity
        var model = otpSettings.ToSettingsModel<OtpSettingsModel>();
    ...
    public virtual async Task<ShoppingCartSettingsModel> PrepareShoppingCartSettingsModelAsync(ShoppingCartSettingsModel model = null)
    {
        ...
        model.ShoppingCartVendorEnabled_OverrideForStore = await _settingService.SettingExistsAsync(shoppingCartSettings, x => x.ShoppingCartVendorEnabled, storeId);
        model.ShoppingCartVendorRequired_OverrideForStore = await _settingService.SettingExistsAsync(shoppingCartSettings, x => x.ShoppingCartVendorRequired, storeId);
